...
export class WeatherForecastClient implements IWeatherForecastClient {
    ...
    constructor(baseUrl?: string, instance?: AxiosInstance) {
        ...
        this.baseUrl = baseUrl !== undefined && baseUrl !== null ? baseUrl : "ws://localhost:7045";

    }

    get(api_version: string | null | undefined , cancelToken?: CancelToken | undefined): Promise<WeatherForecast[]> {
...
export class ChannelClient implements IChannelClient {
    ...
    getChannelMessages(channelId: string , cancelToken?: CancelToken | undefined): Promise<ChannelMessageDto[]> {
    ...
    protected processGetChannelMessages(response: AxiosResponse): Promise<ChannelMessageDto[]> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
    ...
    getChannel(id: string , cancelToken?: CancelToken | undefined): Promise<ChannelDto> {
    ...
    deleteChannel(id: string , cancelToken?: CancelToken | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/v1/channels/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    updateChannel(id: string, channel: ChannelManipulationDto , cancelToken?: CancelToken | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/v1/channels/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    addChannel(channelForCreation: ChannelManipulationDto , cancelToken?: CancelToken | undefined): Promise<ChannelDto> {
...
export class MessageClient implements IMessageClient {
    ...
    saveMessage(message: MessageManipulationDto , cancelToken?: CancelToken | undefined): Promise<ChannelMessageDto> {
    ...
    protected processSaveMessage(response: AxiosResponse): Promise<ChannelMessageDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
    ...
    updateMessage(id: string, message: string | null | undefined , cancelToken?: CancelToken | undefined): Promise<void> {
    ...
    getMessage(id: string , cancelToken?: CancelToken | undefined): Promise<ChannelMessageDto> {
        let url_ = this.baseUrl + "/api/v1/messages/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    protected processGetMessage(response: AxiosResponse): Promise<ChannelMessageDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
    ...
    deleteMessageById(id: string , cancelToken?: CancelToken | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/v1/messages/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    getMessagesFromChannel(id: string , cancelToken?: CancelToken | undefined): Promise<ChannelMessageDto[]> {
    ...
    protected processGetMessagesFromChannel(response: AxiosResponse): Promise<ChannelMessageDto[]> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
...
export class ServerClient implements IServerClient {
    ...
    addServer(serverForCreation: ServerManipulationDto , cancelToken?: CancelToken | undefined): Promise<ServerDto> {
        let url_ = this.baseUrl + "/api/v1/servers";
        url_ = url_.replace(/[?&]$/, "");
    ...
    getServersOfUser(  cancelToken?: CancelToken | undefined): Promise<ServerDto[]> {
    ...
    protected processGetServersOfUser(response: AxiosResponse): Promise<ServerDto[]> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
    ...
    getServerById(serverId: string , cancelToken?: CancelToken | undefined): Promise<ServerDto> {
    ...
    getChannels(serverId: string , cancelToken?: CancelToken | undefined): Promise<ChannelDto[]> {
    ...
    deleteServer(id: string , cancelToken?: CancelToken | undefined): Promise<void> {
    ...
    updateServer(id: string, server: ServerManipulationDto , cancelToken?: CancelToken | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/v1/servers/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    joinServer(serverId: string , cancelToken?: CancelToken | undefined): Promise<void> {
    ...
    leaveServer(serverId: string , cancelToken?: CancelToken | undefined): Promise<void> {
...
export class UserClient implements IUserClient {
     ...
     * @deprecated
     */
    addUser(userForCreation: UserCreationDto , cancelToken?: CancelToken | undefined): Promise<UserDto> {
        let url_ = this.baseUrl + "/api/v1/users";
        url_ = url_.replace(/[?&]$/, "");
    ...
    updateUser(id: string, user: UserManipulationDto , cancelToken?: CancelToken | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/v1/users/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
